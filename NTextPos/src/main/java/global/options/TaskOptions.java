...
/**
 * 
 * Clase que representa las opciones propias de cada tarea, en ella se cargará
 * la tarea el módulo y los parámetros asociados a dicho tarea concreta.
 * Indicado todo en fichero JSON
 * 
 * 
 * 
 */

...
public class JsonToAllConverter {
    ...
    /**
     * CONVERSIÓN INVERSA: JSON -> TEXTO POSICIONAL
     * (El único método que legítimamente necesita el mapa para formatear anchos fijos)
     */
    public void jsonToTxtPos(String jsonPath, String txtPath, Map<String, RecordDefinitionTextPos> mapaDefiniciones) throws IOException {
    ...
    /**
     * CONVERSIÓN INVERSA: JSON -> CSV (Sin dependencias de XML de definición)
     */
    ...
    /**
     * CONVERSIÓN INVERSA: JSON -> EXCEL (Sin dependencias de XML de definición)
     */
